...
function PANEL:AddColumn( strName, iPosition )
	...
	if ( self.m_bSortable ) then
		pColumn = vgui.Create( "HListView_Column", self )
	else
		pColumn = vgui.Create( "HListView_ColumnPlain", self )
	end
...
function PANEL:AddLine( ... )
	...
	local Line = vgui.Create( "HListView_Line", self.pnlCanvas )
...
derma.DefineControl( "HListView", "Data View", PANEL, "DPanel" )